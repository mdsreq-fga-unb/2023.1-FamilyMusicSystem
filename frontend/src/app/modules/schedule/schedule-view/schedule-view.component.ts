...
export class ScheduleViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.scheduleForm = this.fb.group({
      ID_Student: [
        { value: this.schedule?.StudentObject.id, disabled: !this.edit },
        Validators.required,
      ],
      ID_Teacher: [
        { value: this.schedule?.TeacherObject.id, disabled: !this.edit },
        Validators.required,
      ],
      ID_Room: [
        { value: this.schedule?.RoomObject.id, disabled: !this.edit },
        Validators.required,
      ],
      Horary: [
        {
