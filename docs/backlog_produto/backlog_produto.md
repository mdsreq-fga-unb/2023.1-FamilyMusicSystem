...
| <b>[US09] [US10] [US11] [US12]</b>| Os professores devem atualizar suas agendas constantemente, enquanto o administrador deve ter acesso ao registro dessas agendas para marcar novas aulas.                                                                               |
| <b>[US20]</b> | O administrador deve ser capaz de gerar um contrato personalizado para novos alunos através da plataforma.                                              |
